let superMarket = [{
 ...
 // find()
   ...
   document.write("<h1>Items with rating >=3: </h1>");
   superMarket.filter(item => item.rating >=3)
   .forEach(item => {
    document.write(`
        <h2>${item.title}</h2>
...
document.write("<h1>Vegetables: </h1>");
superMarket.filter(item => item.type ==='vegetable')
.forEach(item => {
 document.write(`
     <h2>${item.title}</h2>
     <p>Type: ${item.type}</p>
 ...
 document.write("<h1>Items under < 15: </h1>");
superMarket.filter(item => item.price <15)
.forEach(item => {
 document.write(`
     <h2>${item.title}</h2>
...
document.write("<h1>Items with LEMON in title: </h1>");
superMarket.filter(item => item.title.toLowerCase().includes('lemon'))
.forEach(item => {
 document.write(`
     <h2>${item.title}</h2>
 ...
 document.write("<h1>Items with height = 450 and width = 450: </h1>");
superMarket.filter(item => item.height === 450 && item.width === 450)
.forEach(item => {
 document.write(`
     <h2>${item.title}</h2>
     <hr>
...
// filter()
   ...
   document.write("<h1>Filter the elements with rating < 2: </h1>");
   superMarket.filter(item => item.rating < 2)
   .forEach(item => {
    document.write(`
        <h2>${item.title}</h2>
    ...
    document.write("<h1>Filter the elements with type ‘dairy’: </h1>");
   superMarket.filter(item => item.type ==='dairy')
   .forEach(item => {
    document.write(`
        <h2>${item.title}</h2>
        <p>Type: ${item.type}</p>
   ...
   document.write("<h1> Filter the elements with price >20: </h1>");
   superMarket.filter(item => item.price >20)
   .forEach(item => {
    document.write(`
        <h2>${item.title}</h2>
        <p>Price: ${item.price}</p>
   ...
   document.write("<h1> Filter the elements with title which contains the word ‘with’: </h1>");
   superMarket.filter(item => item.title.toLowerCase().includes('with'))
   .forEach(item => {
    document.write(`
        <h2>${item.title}</h2>
        <p>Title: ${item.title}</p>
   ...
   document.write("<h1> Filter the elements with description which contains the word ‘with’: </h1>");
   superMarket.filter(item => item.description.toLowerCase().includes('with'))
   .forEach(item => {
    document.write(`
        <h2>${item.title}</h2>
  ...
  document.write("<h1> Filter the elements with height = 600 and width = 400: </h1>");
  superMarket.filter(item => item.height === 600 && item.width === 400)
  .forEach(item => {
   document.write(`
       <h2>${item.title}</h2>
       <hr>
...
//map()
   ...
   let updatedSuperMarket = superMarket.map(item => ({ 
   ...item,
   isAvailable: true 
   }));
    document.write("<h1>Updated superMarket</h2>");
